"use strict";
(self["webpackChunkkatalog_restaurant_pwa_to"] = self["webpackChunkkatalog_restaurant_pwa_to"] || []).push([[38],{
...
var dbData = (0,idb__WEBPACK_IMPORTED_MODULE_0__/* .openDB */ .P2)(DATABASE_NAME, DATABASE_VERSION, {
        ...
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            return _context5.abrupt("return", _context5.sent.filter(function (restaurant) {
              var restaurantName = (restaurant.name || '-').toLowerCase().replace(/\s/g, '');
              var restaurantQuery = query.toLowerCase().replace(/\s/g, '');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FavoriteIdb);

/***/ })

}]);
//# sourceMappingURL=app~ead54f52.bundle.js.map